...
namespace ConferencePlus.Entities.ExtensionMethods
{
	...
	public static class DateTimeMethods
	{
		...
		/// <summary>
		/// Gets corresponding day of the week
		/// </summary>
		/// <param name="date" />
		...
		/// <summary>
		/// Gets corresponding day of the following week
		/// </summary>
		/// <param name="date" />
		/// <param name="dayOfWeek" />
		/// <returns>Returns the specified day of the following week</returns>
		public static DateTime GetNextWeekDayOfWeek(this DateTime date, DayOfWeek dayOfWeek)
		{
			return date.GetSaturdayOfWeek().AddDays(1).GetDayOfWeek(dayOfWeek);
		}
		...
		/// <param name="dateToValidate" />
		/// <param name="startDate" />
		/// <returns>True if date is before specified date, false otherwise</returns>
        ...
        /// <summary>
		/// Checks if a DateTime is on or before another date
		/// </summary>
		/// <param name="dateToValidate" />
		/// <param name="startDate" />
		...
		{
			return date.ToLocalTime().ToString("yyyy-MM-dd hh:mm:ss tt");
		}
		...
		/// <summary>
		/// Returns the First Date of Week
		/// </summary>
		/// <param name="year" />
		/// <param name="weekOfYear" />
		/// <returns>First Date of Week</returns>
		public static DateTime FirstDateOfWeek(int year, int weekOfYear)
		{
			...
			int firstWeek
				= CultureInfo.CurrentCulture.Calendar.GetWeekOfYear(jan1,
		...
		/// </summary>
		/// <param name="year" />
		/// <param name="monthOfYear" />
		/// <returns>First Date of Month</returns>
		public static DateTime FirstDateOfMonth(int year, int monthOfYear)
		{
			return new DateTime(year, monthOfYear, 1);
		}

		/// <summary>
		/// Gets the Century from the Date
		/// </summary>
		/// <param name="date" />
		/// <returns>The Century portion of the Year</returns>
		public static string  GetCentury(this DateTime date)
		{
            return date.Year.ToString().SafeSubstring(2).PadLeft(2, '0');
		}

		/// <summary>
		/// Gets the Year (w/o Century) from the Date
		/// </summary>
		/// <param name="date" />
		/// <returns>The Year portion of the Year</returns>
		public static string GetYearWithoutCentury(this DateTime date)
		{
		    return date.Year.ToString().SafeSubstring(2, 2).PadLeft(2, '0');
		}
	}
}
